...
public class fleet_mgmt_sensors extends org.apache.avro.specific.SpecificRecordBase
        implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = -4639197844190934424L;

    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser()
            .parse(
                    "{\"type\":\"record\",\"name\":\"fleet_mgmt_sensors\",\"namespace\":\"fleet_mgmt\",\"fields\":[{\"name\":\"vehicle_id\",\"type\":\"int\"},{\"name\":\"engine_temperature\",\"type\":\"int\"},{\"name\":\"average_rpm\",\"type\":\"int\"}],\"connect.name\":\"fleet_mgmt.fleet_mgmt_sensors\"}");
    ...
    private static final BinaryMessageEncoder<fleet_mgmt_sensors> ENCODER = new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<fleet_mgmt_sensors> DECODER = new BinaryMessageDecoder<>(MODEL$, SCHEMA$);
     ...
     *     this class
     */
    public static fleet_mgmt_sensors fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
     ...
     */
    public fleet_mgmt_sensors(
            java.lang.Integer vehicle_id, java.lang.Integer engine_temperature, java.lang.Integer average_rpm) {
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                ...
                break;
            case 1:
                engine_temperature = (java.lang.Integer) value$;
                break;
            case 2:
                average_rpm = (java.lang.Integer) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
    ...
    /**
     * Creates a new fleet_mgmt_sensors RecordBuilder by copying an existing fleet_mgmt_sensors
     * instance.
     *
        ...
        public fleet_mgmt_sensors build() {
            try {
                ...
                record.engine_temperature =
                        fieldSetFlags()[1] ? this.engine_temperature : (java.lang.Integer) defaultValue(fields()[1]);
                record.average_rpm =
                        fieldSetFlags()[2] ? this.average_rpm : (java.lang.Integer) defaultValue(fields()[2]);
                return record;
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<fleet_mgmt_sensors> WRITER$ =
            (org.apache.avro.io.DatumWriter<fleet_mgmt_sensors>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<fleet_mgmt_sensors> READER$ =
            (org.apache.avro.io.DatumReader<fleet_mgmt_sensors>) MODEL$.createDatumReader(SCHEMA$);
